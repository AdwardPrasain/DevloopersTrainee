...
function TraineeDetails() { 
  ...
  const saveTrainee = (e) => {
      ...
      const result = await axios.get(URL + "TraineeDetails?ClientUserName=" + ClientUserName + "&ClientGUID=" + ClientGUID)
      //console.log(result);
...
return (
  ...
  <div className="buttonn">
    <input type="button" id="btnsubmit" value="Submit" onClick={saveTrainee}/>
   </div>
  </div>
    </div>
)
